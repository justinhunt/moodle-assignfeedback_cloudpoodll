...
$string['submittedtext_instructions']="Enter or paste the text of the student submission that you wish to correct in the textarea below. Click the 'Get Grammar Suggestions' button to get suggested corrections.";
$string['correctedtext_instructions']="Enter and edit the corrected version of the submitted text. When displayed to the student, the original and corrected text will be shown and the differences highlighted.";