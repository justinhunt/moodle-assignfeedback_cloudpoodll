 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assignfeedback_cloudpoodll_subplugin extends restore_subplugin {
    ...
    protected function define_grade_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/feedback_cloudpoodll');
    ...
    public function process_assignfeedback_cloudpoodll_grade($data) {
        ...
        $DB->insert_record('assignfeedback_cloudpoodll', $data);
    }
}
